...
import `in`.co.ngcapp.ngc.adapters.AllFriendsAdapter.AllFriendClick
...
class AllFriendsAdapter(val mContext: Context, var allfriendArrayList: ArrayList<AllFriend> ,var clickAllFriends: clickAllFriends) : RecyclerView.Adapter<AllFriendClick>() {
